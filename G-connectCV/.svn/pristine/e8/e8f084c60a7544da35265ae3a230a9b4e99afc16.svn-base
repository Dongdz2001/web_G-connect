...
import GC_LICH_HANG_NGAYFormView from 'modules/GC_LICH_HANG_NGAY/GC_LICH_HANG_NGAYFormView';
...
dayjs.extend(utc)
const GC_LICH_HANG_NGAYList = (props) => {
    ...
    const codePermAdd = 'PERM_GC_LICH_HANG_NGAY_ADD';
    const codePermModify = 'PERM_GC_LICH_HANG_NGAY_MOD';
    const codePermDel = 'PERM_GC_LICH_HANG_NGAY_DEL';
    const deleteMsg = 'Bạn có chắc chắn xoá bản ghi này không?';
    const titlePage = 'Danh sách Giờ làm việc';
        ...
        <Card title={titlePage}>
            ...
            <Dialog visible={showDialogView} onHide={() => setShowDialogView(false)} position="top" showHeader={false} showFooter={false} breakpoints={{ '960px': '80vw' }} style={{ width: '50vw' }}>
                <div className="flex justify-content-center flex-column pt-6 px-3">
                    <GC_LICH_HANG_NGAYFormView id={selectedId} fnClose={closeDialog}></GC_LICH_HANG_NGAYFormView>
                </div>
            </Dialog>
            <Dialog visible={showDialogEdit} onHide={() => setShowDialogEdit(false)} position="top" showHeader={false} showFooter={false} breakpoints={{ '960px': '80vw' }} style={{ width: '70vw' }}>
                <div className="flex justify-content-center flex-column pt-6 px-3">
                    <GC_LICH_HANG_NGAYForm id={selectedId} fnClose={closeDialog}></GC_LICH_HANG_NGAYForm>
                </div>
            </Dialog>
                ...
                <div className='row mb-2 advancedSearchBox'>
                        ...
                        <div className="field">
                            <span className="p-float-label p-input-icon-right">
                                <i className="pi pi1-envelope" />
                                    <Dropdown options={listRef_id_nguoi_thuc_hien} optionValue='Value' optionLabel='Text' scrollHeight={'600px'} className=''
                        ...
                        <div className="field">
                            <span className="p-float-label p-input-icon-right">
                                <Calendar
                                    ...
                                    dateFormat="dd/mm/yy"
                                    id="ngay_lam_viec"
                                    value={aDVSParams.ngay_lam_viec ? (dayjs(aDVSParams.ngay_lam_viec).$d ?? null) : null}
                                    onChange={(e)=>{
                                    var filter = {
                                        ...aDVSParams,
                                        ngay_lam_viec: e.target.value,
                                    };
                                    setADVSParams(filter);
                                    setLazyParams({
                                        ...lazyParams,
                        ...
                        <div className="field">
                            <span className="p-float-label p-input-icon-right">
                                <Calendar
                                    ...
                                    dateFormat="dd/mm/yy"
                                    id="ngay_checkin"
                                    value={aDVSParams.ngay_checkin ? (dayjs(aDVSParams.ngay_checkin).$d ?? null) : null}
                                    onChange={(e)=>{
                                    var filter = {
                                        ...aDVSParams,
                                        ngay_checkin: e.target.value,
                                    };
                                    setADVSParams(filter);
                                    setLazyParams({
                                        ...lazyParams,
                                    ...
                                    />
                                <label htmlFor="ngay_checkin" >{'Ngày Check-in'}</label>
                            </span>
                        </div>
                    </div>
                    <div className="col-12 col-sm-2">
                        <div className="field">
                            <span className="p-float-label p-input-icon-right">
                                <Calendar
                                    ...
                                    dateFormat="dd/mm/yy"
                                    id="ngay_checkout"
                                    value={aDVSParams.ngay_checkout ? (dayjs(aDVSParams.ngay_checkout).$d ?? null) : null}
                                    onChange={(e)=>{
                                    var filter = {
                                        ...aDVSParams,
                                        ngay_checkout: e.target.value,
                                    };
                                    setADVSParams(filter);
                                    setLazyParams({
                                        ...lazyParams,
                                    ...
                                    />
                                <label htmlFor="ngay_checkout" >{'Ngày Check-out'}</label>
                            </span>
                        </div>
                    </div>
                    <div className="col-12 col-sm-1">
                        <div className="field">
                            <span className="p-float-label p-input-icon-right">
                                <i className="pi pi1-envelope" />
                                <InputText name="so_gio" onChange={(e)=>{
                                    var filter = {
                                        ...aDVSParams,
                                        so_gio: e.target.value,
                                    };
                                    setADVSParams(filter);
                                    setLazyParams({
                                        ...lazyParams,
...
export default GC_LICH_HANG_NGAYList;
