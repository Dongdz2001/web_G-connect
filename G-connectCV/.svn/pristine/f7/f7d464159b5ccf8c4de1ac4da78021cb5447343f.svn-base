...
import { Calendar as CalendarPrime, CalendarChangeParams, CalendarProps } from "primereact/calendar";
...
return(<CalendarPrime id={props.id} {...props}  value={innerValue}  ref={ref}  locale="vi" />)
})
