...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ClientClaims
    /// </summary>
    [Route("api/link-ClientClaims")]
    [AuthorizeApi]
    [ApiController]
    public class ClientClaimsController : ControllerBase
    {
        private readonly ClientClaimsIService _serviceClientClaims;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientClaimsController(ClientClaimsIService serviceClientClaims,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceClientClaims = serviceClientClaims;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientClaims.GetManyAsync<ClientClaimsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientClaims.GetManyAsync<ClientClaimsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientClaims.GetManyAsync<ClientClaimsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClientClaims.GetByIdAsync<ClientClaimsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientClaimsDTO obj)
        {
            try
            {
                var result = await _serviceClientClaims.CreateAsync<ClientClaimsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ClientClaims";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ClientClaims-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientClaimsDTO obj, int id)
        {
            try
            {
                var result = await _serviceClientClaims.UpdateAsync<ClientClaimsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClientClaims.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClientClaims.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
