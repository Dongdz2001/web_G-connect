...
namespace App.Api.Controllers.DBAll
{
    ...
    /// GC_LICH_TUAN
    /// </summary>
    [Route("api/link-GC_LICH_TUAN")]
    [AuthorizeApi]
    [ApiController]
    public class GC_LICH_TUANController : ControllerBase
    {
        private readonly GC_LICH_TUANIService _serviceGC_LICH_TUAN;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public GC_LICH_TUANController(GC_LICH_TUANIService serviceGC_LICH_TUAN,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceGC_LICH_TUAN = serviceGC_LICH_TUAN;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.GetManyAsync<GC_LICH_TUANDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.GetManyAsync<GC_LICH_TUANDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.GetManyAsync<GC_LICH_TUANSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.GetByIdAsync<GC_LICH_TUANDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] GC_LICH_TUANDTO obj)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.CreateAsync<GC_LICH_TUANDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "GC_LICH_TUAN";
                        nkht.ban_ghi_id = (result.id);
                        nkht.duong_dan = "/link-GC_LICH_TUAN-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] GC_LICH_TUANDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.UpdateAsync<GC_LICH_TUANDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceGC_LICH_TUAN.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceGC_LICH_TUAN.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
