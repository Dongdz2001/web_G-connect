...
const qtht_nhom_nguoi_dungFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of qtht_nhom_nguoi_dung'}>
                <div className="view-form">
                    <div className='row'>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="mota" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
...
export default qtht_nhom_nguoi_dungFormView;
