...
namespace App.Api.Controllers.DBAll
{
    ...
    /// GC_DM_TRANG_THAI
    /// </summary>
    [Route("api/link-GC_DM_TRANG_THAI")]
    [AuthorizeApi]
    [ApiController]
    public class GC_DM_TRANG_THAIController : ControllerBase
    {
        private readonly GC_DM_TRANG_THAIIService _serviceGC_DM_TRANG_THAI;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public GC_DM_TRANG_THAIController(GC_DM_TRANG_THAIIService serviceGC_DM_TRANG_THAI,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceGC_DM_TRANG_THAI = serviceGC_DM_TRANG_THAI;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.GetManyAsync<GC_DM_TRANG_THAIDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.GetManyAsync<GC_DM_TRANG_THAIDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.GetManyAsync<GC_DM_TRANG_THAISelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.GetByIdAsync<GC_DM_TRANG_THAIDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] GC_DM_TRANG_THAIDTO obj)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.CreateAsync<GC_DM_TRANG_THAIDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "GC_DM_TRANG_THAI";
                        nkht.ban_ghi_id = (result.id);
                        nkht.duong_dan = "/link-GC_DM_TRANG_THAI-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] GC_DM_TRANG_THAIDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.UpdateAsync<GC_DM_TRANG_THAIDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceGC_DM_TRANG_THAI.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
