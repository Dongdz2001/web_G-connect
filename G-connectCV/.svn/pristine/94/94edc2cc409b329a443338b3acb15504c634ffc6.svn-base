...
const qtht_google_configForm = (props) => {
    const { t, i18n } = useTranslation();
    let { id } = useParams();
    let itemId = props.id ?? id;
    const linkList = '/admin/qtht_google_config';
    const labelSave = 'Lưu';
    const labelClose = 'Đóng';
    const itemService = qtht_google_configService;
    ...
    return (
        <div >
            ...
            <Card title={(itemId === 'new' ? 'Thêm' : 'Sửa') + ' Title of qtht_google_config'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                <label htmlFor="email">
                                    {'Title of email'} <span className='p-error'>(*)</span>
                                </label>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                <label htmlFor="refresh_token">
                                    {'Title of refresh_token'} <span className='p-error'>(*)</span>
                                </label>
                                <Controller name="refresh_token" control={control} rules={{ 
                                    required: {
                                        value: true,
                                        message: 'Vui lòng nhập!'
                                    }, 
                                ...
                                {getFormErrorMessage('refresh_token', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
...
export default qtht_google_configForm;
