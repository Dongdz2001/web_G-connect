...
const qtht_nhom_nguoi_dungForm = (props) => {
    const { t, i18n } = useTranslation();
    let { id } = useParams();
    let itemId = props.id ?? id;
    const linkList = '/admin/qtht_nhom_nguoi_dung';
    const labelSave = 'Lưu';
    const labelClose = 'Đóng';
    const itemService = qtht_nhom_nguoi_dungService;
    ...
    return (
        <div >
            ...
            <Card title={(itemId === 'new' ? 'Thêm' : 'Sửa') + ' Title of qtht_nhom_nguoi_dung'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                ...
                                <Controller name="mota" control={control} rules={{ 
                                    //validate: value => value === 'pwd' || "The passwords do not match",
                                    //pattern: {
                                    //  value: /^[a-zA-Z]+$/,
                                    //  message: 'pattern'
                                ...
                                {getFormErrorMessage('mota', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
...
export default qtht_nhom_nguoi_dungForm;
