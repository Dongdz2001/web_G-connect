...
const qtht_google_configFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of qtht_google_config'}>
                        ...
                        <div className="col-12">
                            <div className="col-sm-2">
                                <label htmlFor="refresh_token">
                                    {'Title of refresh_token'}
                                </label>
                            </div>
                            <div className="col-sm-10">
                                <Controller name="refresh_token" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
...
export default qtht_google_configFormView;
