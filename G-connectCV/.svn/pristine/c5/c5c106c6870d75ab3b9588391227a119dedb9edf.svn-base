...
const qtht_nguoi_dung_2_nhom_nguoi_dungFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of qtht_nguoi_dung_2_nhom_nguoi_dung'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-2">
                                <label htmlFor="ten_nhom_nguoi_dung_id">
                                    {'Title of nhom_nguoi_dung_id'}
                                </label>
                            </div>
                            <div className="col-sm-10">
                                <Controller name="ten_nhom_nguoi_dung_id" control={control} render={({ field, fieldState }) => (
...
export default qtht_nguoi_dung_2_nhom_nguoi_dungFormView;
