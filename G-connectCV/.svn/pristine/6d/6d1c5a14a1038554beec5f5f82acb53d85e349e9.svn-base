...
{
    public class ApiScopeClaimsService : GenericServiceInt<ApiScopeClaims>, ApiScopeClaimsIService
    {
        //private readonly IFileDinhKemService _fileSV;
        public ApiScopeClaimsService(APPContext dbContext)
           : base(dbContext)
        {
            ...
            _mapperCfg = new MapperConfiguration(cfg =>
            {
                ...
                cfg.AddProfile<ApiScopeClaimsProfile>();
                //cfg.CreateMap<IDataRecord, ApiScopeClaimsDTO>();
            });
        ...
        protected override IQueryable<ApiScopeClaims> QueryBuilder(IQueryable<ApiScopeClaims> query, dynamic filter, string search)
        {
            if (filter != null)
            {
        ...
        protected override void BeforeMapper<TDto>(bool isNew, ref TDto dto)
        {
            ...
            if (typeof(TDto) == typeof(ApiScopeClaimsDTO))
            {
                ApiScopeClaimsDTO ApiScopeClaimsDTO = (ApiScopeClaimsDTO)(object)dto;
                //xu ly tai day
                //var checkExist = _repo.Where(x => x.ma.ToLower() == ApiScopeClaimsDTO.ma.ToLower() && x.id != ApiScopeClaimsDTO.id);
        ...
        protected override void BeforeAddOrUpdate<TDto>(bool isNew, ref TDto dto, ref ApiScopeClaims entity)
        {
            var currentUser = AppHelpers.GetCurrentUser();
            if (typeof(TDto) != typeof(ApiScopeClaimsDTO))
            {
        ...
        protected override void AfterAddOrUpdate<TDto>(bool isNew, ref TDto dto, ref ApiScopeClaims entity)
        {
            var currentUser = AppHelpers.GetCurrentUser();
            if (typeof(TDto) == typeof(ApiScopeClaimsDTO))
            {
