...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ClientCorsOrigins
    /// </summary>
    [Route("api/link-ClientCorsOrigins")]
    [AuthorizeApi]
    [ApiController]
    public class ClientCorsOriginsController : ControllerBase
    {
        private readonly ClientCorsOriginsIService _serviceClientCorsOrigins;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientCorsOriginsController(ClientCorsOriginsIService serviceClientCorsOrigins,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceClientCorsOrigins = serviceClientCorsOrigins;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.GetManyAsync<ClientCorsOriginsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.GetManyAsync<ClientCorsOriginsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.GetManyAsync<ClientCorsOriginsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.GetByIdAsync<ClientCorsOriginsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientCorsOriginsDTO obj)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.CreateAsync<ClientCorsOriginsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ClientCorsOrigins";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ClientCorsOrigins-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientCorsOriginsDTO obj, int id)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.UpdateAsync<ClientCorsOriginsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClientCorsOrigins.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClientCorsOrigins.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
