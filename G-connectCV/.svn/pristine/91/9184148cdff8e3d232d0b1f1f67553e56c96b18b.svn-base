...
const GC_DM_TRANG_THAIForm = (props) => {
    const { t, i18n } = useTranslation();
    let { id } = useParams();
    let itemId = props.id ?? id;
    const linkList = '/admin/GC_DM_TRANG_THAI';
    const labelSave = 'Lưu';
    const labelClose = 'Đóng';
    const itemService = GC_DM_TRANG_THAIService;
    ...
    return (
        <div >
            ...
            <Card title={(itemId === 'new' ? 'Thêm' : 'Sửa') + ' Danh mục Trạng thái'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                <label htmlFor="ten_trang_thai">
                                    {'Tên trạng thái'} <span className='p-error'>(*)</span>
                                </label>
                                <Controller name="ten_trang_thai" control={control} rules={{ 
                                    required: {
                                        value: true,
                                ...
                                {getFormErrorMessage('ten_trang_thai', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
...
export default GC_DM_TRANG_THAIForm;
