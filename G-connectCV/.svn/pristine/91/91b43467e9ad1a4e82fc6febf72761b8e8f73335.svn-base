    ...
    public class GC_CONG_VIEC_PHAN_CONGProfile : Profile
    {
        public GC_CONG_VIEC_PHAN_CONGProfile()
        {
            CreateMap<GC_CONG_VIEC_PHAN_CONG, GC_CONG_VIEC_PHAN_CONGSelectDTO>()
                ...
                .ForMember(x => x.id_du_an, otp => otp.MapFrom(z => z.GC_CHUC_NANG_id_chuc_nang != null ? z.GC_CHUC_NANG_id_chuc_nang.id_du_an : null))
                .ForMember(x => x.id_chuc_nang, otp => otp.MapFrom(z => z.id_chuc_nang))
                ;
