...
const GC_DM_LOAI_DU_ANFormView = (props) => {
    const { t, i18n } = useTranslation();
    let { id } = useParams();
    let itemId = props.id ?? id;
    const linkList = '/admin/GC_DM_LOAI_DU_AN';
    const labelSave = 'Lưu';
    const labelClose = 'Đóng';
    const itemService = GC_DM_LOAI_DU_ANService;
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Danh mục Loại dự án'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-2">
                                <label htmlFor="ten_loai_du_an">
                                    {'Tên loại dự án'}
                                </label>
                            </div>
                            <div className="col-sm-10">
                                <Controller name="ten_loai_du_an" control={control} render={({ field, fieldState }) => (
...
export default GC_DM_LOAI_DU_ANFormView;
