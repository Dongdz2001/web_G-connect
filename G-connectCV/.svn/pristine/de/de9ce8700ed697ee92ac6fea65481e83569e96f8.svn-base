...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// Clients
    /// </summary>
    [Route("api/link-Clients")]
    [AuthorizeApi]
    [ApiController]
    public class ClientsController : ControllerBase
    {
        private readonly ClientsIService _serviceClients;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientsController(ClientsIService serviceClients,
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClients.GetManyAsync<ClientsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClients.GetManyAsync<ClientsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClients.GetManyAsync<ClientsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClients.GetByIdAsync<ClientsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientsDTO obj)
        {
            try
            {
                var result = await _serviceClients.CreateAsync<ClientsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.duong_dan = "/link-Clients-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientsDTO obj, int id)
        {
            try
            {
                var result = await _serviceClients.UpdateAsync<ClientsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClients.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClients.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
