...
const GC_DM_LINH_VUCForm = (props) => {
    ...
    return (
        <div >
            ...
            <Card title={(itemId === 'new' ? 'Thêm' : 'Sửa') + ' Danh mục Lĩnh vực'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                <label htmlFor="id_linh_vuc_cha">
                                    {'Lĩnh vực cha'} 
                                </label>
                                <Controller name="id_linh_vuc_cha" control={control} rules={{ 
                                    ...
                                    <Dropdown options={listRef_id_linh_vuc_cha} optionValue='Value' optionLabel='Text' scrollHeight={'600px'} className=''
                                        {...field}
                                        value={field.value??''}
                                        placeholder='--Chọn--'
                                        showClear
                                ...
                                {getFormErrorMessage('id_linh_vuc_cha', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
                                <label htmlFor="ten_linh_vuc">
                                    {'Tên lĩnh vực'} <span className='p-error'>(*)</span>
                                </label>
                                <Controller name="ten_linh_vuc" control={control} rules={{ 
                                    required: {
                                        value: true,
                                ...
                                {getFormErrorMessage('ten_linh_vuc', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
...
export default GC_DM_LINH_VUCForm;
