...
const GC_DM_LOAI_CHECK_LISTFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Danh mục Loại checklist'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="ten_loai_check_list" control={control} render={({ field, fieldState }) => (
...
export default GC_DM_LOAI_CHECK_LISTFormView;
