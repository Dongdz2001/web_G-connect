    ...
    public class GC_LICH_HANG_NGAYProfile : Profile
    {
        public GC_LICH_HANG_NGAYProfile()
        {
            ...
            CreateMap<GC_LICH_HANG_NGAY, GC_LICH_HANG_NGAYDTO>()
                ...
                .ForMember(x => x.ten_chuc_nang, otp => otp.MapFrom(z => z.GC_CONG_VIEC_PHAN_CONG_id_cong_viec.GC_CHUC_NANG_id_chuc_nang.ten_chuc_nang))
                .ForMember(x => x.ten_du_an, otp => otp.MapFrom(z => z.GC_CONG_VIEC_PHAN_CONG_id_cong_viec.GC_CHUC_NANG_id_chuc_nang.GC_DU_AN_id_du_an.ten_du_an))
