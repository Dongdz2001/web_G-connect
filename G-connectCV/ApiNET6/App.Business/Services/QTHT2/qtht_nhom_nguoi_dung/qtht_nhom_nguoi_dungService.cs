...
{
    public class qtht_nhom_nguoi_dungService : GenericService<nhom_nguoi_dung>, qtht_nhom_nguoi_dungIService
    {
        //private readonly IFileDinhKemService _fileSV;
        public qtht_nhom_nguoi_dungService(APPContext dbContext)
           : base(dbContext)
        {
            ...
            _mapperCfg = new MapperConfiguration(cfg =>
            {
                ...
                cfg.AddProfile<qtht_nhom_nguoi_dungProfile>();
                //cfg.CreateMap<IDataRecord, qtht_nhom_nguoi_dungDTO>();
            });
        ...
        protected override void BeforeMapper<TDto>(bool isNew, ref TDto dto)
        {
            ...
            if (typeof(TDto) == typeof(qtht_nhom_nguoi_dungDTO))
            {
                qtht_nhom_nguoi_dungDTO qtht_nhom_nguoi_dungDTO = (qtht_nhom_nguoi_dungDTO)(object)dto;
                //xu ly tai day
                //var checkExist = _repo.Where(x => x.ma.ToLower() == qtht_nhom_nguoi_dungDTO.ma.ToLower() && x.id != qtht_nhom_nguoi_dungDTO.id);
