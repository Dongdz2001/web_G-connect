...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// IdentityResources
    /// </summary>
    [Route("api/link-IdentityResources")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class IdentityResourcesController : ControllerBase
    {
        private readonly IdentityResourcesIService _serviceIdentityResources;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public IdentityResourcesController(IdentityResourcesIService serviceIdentityResources,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceIdentityResources = serviceIdentityResources;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceIdentityResources.GetManyAsync<IdentityResourcesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceIdentityResources.GetManyAsync<IdentityResourcesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceIdentityResources.GetManyAsync<IdentityResourcesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceIdentityResources.GetByIdAsync<IdentityResourcesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] IdentityResourcesDTO obj)
        {
            try
            {
                var result = await _serviceIdentityResources.CreateAsync<IdentityResourcesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "IdentityResources";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-IdentityResources-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] IdentityResourcesDTO obj, int id)
        {
            try
            {
                var result = await _serviceIdentityResources.UpdateAsync<IdentityResourcesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceIdentityResources.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceIdentityResources.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
