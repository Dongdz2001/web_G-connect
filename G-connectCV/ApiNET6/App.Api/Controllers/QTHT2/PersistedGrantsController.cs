...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// PersistedGrants
    /// </summary>
    [Route("api/link-PersistedGrants")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class PersistedGrantsController : ControllerBase
    {
        private readonly PersistedGrantsIService _servicePersistedGrants;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public PersistedGrantsController(PersistedGrantsIService servicePersistedGrants,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _servicePersistedGrants = servicePersistedGrants;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _servicePersistedGrants.GetManyAsync<PersistedGrantsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _servicePersistedGrants.GetManyAsync<PersistedGrantsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _servicePersistedGrants.GetManyAsync<PersistedGrantsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _servicePersistedGrants.GetByIdAsync<PersistedGrantsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] PersistedGrantsDTO obj)
        {
            try
            {
                var result = await _servicePersistedGrants.CreateAsync<PersistedGrantsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "PersistedGrants";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-PersistedGrants-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] PersistedGrantsDTO obj, int id)
        {
            try
            {
                var result = await _servicePersistedGrants.UpdateAsync<PersistedGrantsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _servicePersistedGrants.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _servicePersistedGrants.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
