...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// </summary>
    [Route("api/link-IdentityResourceClaims")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class IdentityResourceClaimsController : ControllerBase
    {
        private readonly IdentityResourceClaimsIService _serviceIdentityResourceClaims;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public IdentityResourceClaimsController(IdentityResourceClaimsIService serviceIdentityResourceClaims,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceIdentityResourceClaims = serviceIdentityResourceClaims;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.GetManyAsync<IdentityResourceClaimsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.GetManyAsync<IdentityResourceClaimsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.GetManyAsync<IdentityResourceClaimsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.GetByIdAsync<IdentityResourceClaimsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] IdentityResourceClaimsDTO obj)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.CreateAsync<IdentityResourceClaimsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "IdentityResourceClaims";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-IdentityResourceClaims-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] IdentityResourceClaimsDTO obj, int id)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.UpdateAsync<IdentityResourceClaimsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceIdentityResourceClaims.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceIdentityResourceClaims.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
