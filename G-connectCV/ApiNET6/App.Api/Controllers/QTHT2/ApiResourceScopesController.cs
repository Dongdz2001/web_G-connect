...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ApiResourceScopes
    /// </summary>
    [Route("api/link-ApiResourceScopes")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class ApiResourceScopesController : ControllerBase
    {
        private readonly ApiResourceScopesIService _serviceApiResourceScopes;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ApiResourceScopesController(ApiResourceScopesIService serviceApiResourceScopes,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceApiResourceScopes = serviceApiResourceScopes;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceScopes.GetManyAsync<ApiResourceScopesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceScopes.GetManyAsync<ApiResourceScopesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceScopes.GetManyAsync<ApiResourceScopesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceApiResourceScopes.GetByIdAsync<ApiResourceScopesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ApiResourceScopesDTO obj)
        {
            try
            {
                var result = await _serviceApiResourceScopes.CreateAsync<ApiResourceScopesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ApiResourceScopes";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ApiResourceScopes-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ApiResourceScopesDTO obj, int id)
        {
            try
            {
                var result = await _serviceApiResourceScopes.UpdateAsync<ApiResourceScopesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceApiResourceScopes.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceApiResourceScopes.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
