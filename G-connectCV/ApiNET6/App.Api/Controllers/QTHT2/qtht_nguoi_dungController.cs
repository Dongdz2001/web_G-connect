...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// qtht_nguoi_dung
    /// </summary>
    [Route("api/link-qtht_nguoi_dung")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class qtht_nguoi_dungController : ControllerBase
    {
        private readonly qtht_nguoi_dungIService _serviceqtht_nguoi_dung;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public qtht_nguoi_dungController(qtht_nguoi_dungIService serviceqtht_nguoi_dung,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceqtht_nguoi_dung = serviceqtht_nguoi_dung;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_nguoi_dung.GetManyAsync<qtht_nguoi_dungDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_nguoi_dung.GetManyAsync<qtht_nguoi_dungDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                if (sort == null) sort = "{\"ten\": 1}";
                var result = await _serviceqtht_nguoi_dung.GetManyAsync<qtht_nguoi_dungSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceqtht_nguoi_dung.GetByIdAsync<qtht_nguoi_dungDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] qtht_nguoi_dungDTO obj)
        {
            try
            {
                var result = await _serviceqtht_nguoi_dung.CreateAsync<qtht_nguoi_dungDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.duong_dan = "/link-qtht_nguoi_dung-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] qtht_nguoi_dungDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceqtht_nguoi_dung.UpdateAsync<qtht_nguoi_dungDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceqtht_nguoi_dung.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceqtht_nguoi_dung.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
