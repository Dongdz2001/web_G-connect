...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// </summary>
    [Route("api/link-ApiResourceProperties")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class ApiResourcePropertiesController : ControllerBase
    {
        private readonly ApiResourcePropertiesIService _serviceApiResourceProperties;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ApiResourcePropertiesController(ApiResourcePropertiesIService serviceApiResourceProperties,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceApiResourceProperties = serviceApiResourceProperties;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceProperties.GetManyAsync<ApiResourcePropertiesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceProperties.GetManyAsync<ApiResourcePropertiesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceProperties.GetManyAsync<ApiResourcePropertiesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceApiResourceProperties.GetByIdAsync<ApiResourcePropertiesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ApiResourcePropertiesDTO obj)
        {
            try
            {
                var result = await _serviceApiResourceProperties.CreateAsync<ApiResourcePropertiesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ApiResourceProperties";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ApiResourceProperties-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ApiResourcePropertiesDTO obj, int id)
        {
            try
            {
                var result = await _serviceApiResourceProperties.UpdateAsync<ApiResourcePropertiesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceApiResourceProperties.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceApiResourceProperties.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
