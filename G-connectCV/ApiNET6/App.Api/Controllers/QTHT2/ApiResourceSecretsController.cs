...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ApiResourceSecrets
    /// </summary>
    [Route("api/link-ApiResourceSecrets")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class ApiResourceSecretsController : ControllerBase
    {
        private readonly ApiResourceSecretsIService _serviceApiResourceSecrets;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ApiResourceSecretsController(ApiResourceSecretsIService serviceApiResourceSecrets,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceApiResourceSecrets = serviceApiResourceSecrets;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.GetManyAsync<ApiResourceSecretsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.GetManyAsync<ApiResourceSecretsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.GetManyAsync<ApiResourceSecretsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.GetByIdAsync<ApiResourceSecretsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ApiResourceSecretsDTO obj)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.CreateAsync<ApiResourceSecretsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ApiResourceSecrets";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ApiResourceSecrets-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ApiResourceSecretsDTO obj, int id)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.UpdateAsync<ApiResourceSecretsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceApiResourceSecrets.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceApiResourceSecrets.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
