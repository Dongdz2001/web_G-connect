...
namespace App.Api.Controllers.DBAll
{
    ...
    /// GC_DU_AN
    /// </summary>
    [Route("api/link-GC_DU_AN")]
    //phongnhxxx [AuthorizeApi]
    [ApiController]
    public class GC_DU_ANController : ControllerBase
    {
        private readonly GC_DU_ANIService _serviceGC_DU_AN;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public GC_DU_ANController(GC_DU_ANIService serviceGC_DU_AN,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceGC_DU_AN = serviceGC_DU_AN;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                if (!string.IsNullOrEmpty(filter)) filter = filter.Replace("\"is_da_dong\":1", "\"is_da_dong\":false").Replace("\"is_da_dong\":2", "\"is_da_dong\":true");
                var result = await _serviceGC_DU_AN.GetManyAsync<GC_DU_ANDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DU_AN.GetManyAsync<GC_DU_ANDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DU_AN.GetManyAsync<GC_DU_ANSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceGC_DU_AN.GetByIdAsync<GC_DU_ANDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] GC_DU_ANDTO obj)
        {
            try
            {
                var result = await _serviceGC_DU_AN.CreateAsync<GC_DU_ANDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.duong_dan = "/link-GC_DU_AN-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] GC_DU_ANDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceGC_DU_AN.UpdateAsync<GC_DU_ANDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceGC_DU_AN.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceGC_DU_AN.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
