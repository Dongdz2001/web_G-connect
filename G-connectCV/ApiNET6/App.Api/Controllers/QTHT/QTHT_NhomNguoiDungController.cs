...
{
    [Route("api/qtht-nhom-nguoidung")]
    public class QTHT_NhomNguoiDungController : ControllerBase
    {
        private readonly INhomNguoiDungService _service;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public QTHT_NhomNguoiDungController(INhomNguoiDungService service,
            ...
            try
            {
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.duong_dan = "/nhom-nguoidung-view/" + result.id.ToString();
                        nkht.hanh_dong = "214";
            ...
            try
            {
                ...
                try
                {
                    if (result == true)
                    {
                        ...
                        nkht.duong_dan = "/nhom-nguoidung-view/" + obj.nhom_id.ToString();
                        nkht.hanh_dong = "217";
        ...
        #endregion
        #region Get danh sách người dùng quản lý tài chính
        /// <summary>
        /// Lấy danh sách người dùng quản lý tài chính
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        [Route("all-user-qltc")]
        public ActionResult AllUserQLTC()
        {
            try
            {
                var result = _service.danhSachNguoiDungQLTC();
                return Ok(result);
            }
            catch (Exception ex)
            {
