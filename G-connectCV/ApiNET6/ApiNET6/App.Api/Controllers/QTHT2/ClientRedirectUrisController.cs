...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ClientRedirectUris
    /// </summary>
    [Route("api/link-ClientRedirectUris")]
    [AuthorizeApi]
    [ApiController]
    public class ClientRedirectUrisController : ControllerBase
    {
        private readonly ClientRedirectUrisIService _serviceClientRedirectUris;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientRedirectUrisController(ClientRedirectUrisIService serviceClientRedirectUris,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceClientRedirectUris = serviceClientRedirectUris;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientRedirectUris.GetManyAsync<ClientRedirectUrisDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientRedirectUris.GetManyAsync<ClientRedirectUrisDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientRedirectUris.GetManyAsync<ClientRedirectUrisSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClientRedirectUris.GetByIdAsync<ClientRedirectUrisDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientRedirectUrisDTO obj)
        {
            try
            {
                var result = await _serviceClientRedirectUris.CreateAsync<ClientRedirectUrisDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ClientRedirectUris";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ClientRedirectUris-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientRedirectUrisDTO obj, int id)
        {
            try
            {
                var result = await _serviceClientRedirectUris.UpdateAsync<ClientRedirectUrisDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClientRedirectUris.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClientRedirectUris.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
