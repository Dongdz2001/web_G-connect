...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ClientProperties
    /// </summary>
    [Route("api/link-ClientProperties")]
    [AuthorizeApi]
    [ApiController]
    public class ClientPropertiesController : ControllerBase
    {
        private readonly ClientPropertiesIService _serviceClientProperties;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientPropertiesController(ClientPropertiesIService serviceClientProperties,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceClientProperties = serviceClientProperties;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientProperties.GetManyAsync<ClientPropertiesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientProperties.GetManyAsync<ClientPropertiesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientProperties.GetManyAsync<ClientPropertiesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClientProperties.GetByIdAsync<ClientPropertiesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientPropertiesDTO obj)
        {
            try
            {
                var result = await _serviceClientProperties.CreateAsync<ClientPropertiesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ClientProperties";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ClientProperties-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientPropertiesDTO obj, int id)
        {
            try
            {
                var result = await _serviceClientProperties.UpdateAsync<ClientPropertiesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClientProperties.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClientProperties.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
