...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// qtht_chuc_vu
    /// </summary>
    [Route("api/link-qtht_chuc_vu")]
    [AuthorizeApi]
    [ApiController]
    public class qtht_chuc_vuController : ControllerBase
    {
        private readonly qtht_chuc_vuIService _serviceqtht_chuc_vu;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public qtht_chuc_vuController(qtht_chuc_vuIService serviceqtht_chuc_vu,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceqtht_chuc_vu = serviceqtht_chuc_vu;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.GetManyAsync<qtht_chuc_vuDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.GetManyAsync<qtht_chuc_vuDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.GetManyAsync<qtht_chuc_vuSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.GetByIdAsync<qtht_chuc_vuDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] qtht_chuc_vuDTO obj)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.CreateAsync<qtht_chuc_vuDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "qtht_chuc_vu";
                        nkht.ban_ghi_id = (result.id);
                        nkht.duong_dan = "/link-qtht_chuc_vu-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] qtht_chuc_vuDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.UpdateAsync<qtht_chuc_vuDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceqtht_chuc_vu.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceqtht_chuc_vu.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
