...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ClientSecrets
    /// </summary>
    [Route("api/link-ClientSecrets")]
    [AuthorizeApi]
    [ApiController]
    public class ClientSecretsController : ControllerBase
    {
        private readonly ClientSecretsIService _serviceClientSecrets;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientSecretsController(ClientSecretsIService serviceClientSecrets,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceClientSecrets = serviceClientSecrets;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientSecrets.GetManyAsync<ClientSecretsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientSecrets.GetManyAsync<ClientSecretsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientSecrets.GetManyAsync<ClientSecretsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClientSecrets.GetByIdAsync<ClientSecretsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientSecretsDTO obj)
        {
            try
            {
                var result = await _serviceClientSecrets.CreateAsync<ClientSecretsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ClientSecrets";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ClientSecrets-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientSecretsDTO obj, int id)
        {
            try
            {
                var result = await _serviceClientSecrets.UpdateAsync<ClientSecretsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClientSecrets.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClientSecrets.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
