...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// DeviceCodes
    /// </summary>
    [Route("api/link-DeviceCodes")]
    [AuthorizeApi]
    [ApiController]
    public class DeviceCodesController : ControllerBase
    {
        private readonly DeviceCodesIService _serviceDeviceCodes;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public DeviceCodesController(DeviceCodesIService serviceDeviceCodes,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceDeviceCodes = serviceDeviceCodes;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceDeviceCodes.GetManyAsync<DeviceCodesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceDeviceCodes.GetManyAsync<DeviceCodesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceDeviceCodes.GetManyAsync<DeviceCodesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceDeviceCodes.GetByIdAsync<DeviceCodesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] DeviceCodesDTO obj)
        {
            try
            {
                var result = await _serviceDeviceCodes.CreateAsync<DeviceCodesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "DeviceCodes";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-DeviceCodes-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] DeviceCodesDTO obj, int id)
        {
            try
            {
                var result = await _serviceDeviceCodes.UpdateAsync<DeviceCodesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceDeviceCodes.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceDeviceCodes.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
