...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ClientScopes
    /// </summary>
    [Route("api/link-ClientScopes")]
    [AuthorizeApi]
    [ApiController]
    public class ClientScopesController : ControllerBase
    {
        private readonly ClientScopesIService _serviceClientScopes;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ClientScopesController(ClientScopesIService serviceClientScopes,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceClientScopes = serviceClientScopes;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientScopes.GetManyAsync<ClientScopesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientScopes.GetManyAsync<ClientScopesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceClientScopes.GetManyAsync<ClientScopesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceClientScopes.GetByIdAsync<ClientScopesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ClientScopesDTO obj)
        {
            try
            {
                var result = await _serviceClientScopes.CreateAsync<ClientScopesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ClientScopes";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ClientScopes-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ClientScopesDTO obj, int id)
        {
            try
            {
                var result = await _serviceClientScopes.UpdateAsync<ClientScopesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceClientScopes.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceClientScopes.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
