...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// qtht_cau_hinh_ma
    /// </summary>
    [Route("api/link-qtht_cau_hinh_ma")]
    [AuthorizeApi]
    [ApiController]
    public class qtht_cau_hinh_maController : ControllerBase
    {
        private readonly qtht_cau_hinh_maIService _serviceqtht_cau_hinh_ma;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public qtht_cau_hinh_maController(qtht_cau_hinh_maIService serviceqtht_cau_hinh_ma,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceqtht_cau_hinh_ma = serviceqtht_cau_hinh_ma;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.GetManyAsync<qtht_cau_hinh_maDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.GetManyAsync<qtht_cau_hinh_maDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.GetManyAsync<qtht_cau_hinh_maSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.GetByIdAsync<qtht_cau_hinh_maDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] qtht_cau_hinh_maDTO obj)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.CreateAsync<qtht_cau_hinh_maDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "qtht_cau_hinh_ma";
                        nkht.ban_ghi_id = (result.id);
                        nkht.duong_dan = "/link-qtht_cau_hinh_ma-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] qtht_cau_hinh_maDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.UpdateAsync<qtht_cau_hinh_maDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceqtht_cau_hinh_ma.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
