...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ApiResources
    /// </summary>
    [Route("api/link-ApiResources")]
    [AuthorizeApi]
    [ApiController]
    public class ApiResourcesController : ControllerBase
    {
        private readonly ApiResourcesIService _serviceApiResources;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ApiResourcesController(ApiResourcesIService serviceApiResources,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceApiResources = serviceApiResources;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResources.GetManyAsync<ApiResourcesDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResources.GetManyAsync<ApiResourcesDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResources.GetManyAsync<ApiResourcesSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceApiResources.GetByIdAsync<ApiResourcesDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ApiResourcesDTO obj)
        {
            try
            {
                var result = await _serviceApiResources.CreateAsync<ApiResourcesDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ApiResources";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ApiResources-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ApiResourcesDTO obj, int id)
        {
            try
            {
                var result = await _serviceApiResources.UpdateAsync<ApiResourcesDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceApiResources.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceApiResources.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
