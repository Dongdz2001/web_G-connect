...
namespace App.Api.Controllers.QTHT2
{
    ...
    /// ApiResourceClaims
    /// </summary>
    [Route("api/link-ApiResourceClaims")]
    [AuthorizeApi]
    [ApiController]
    public class ApiResourceClaimsController : ControllerBase
    {
        private readonly ApiResourceClaimsIService _serviceApiResourceClaims;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public ApiResourceClaimsController(ApiResourceClaimsIService serviceApiResourceClaims,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceApiResourceClaims = serviceApiResourceClaims;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceClaims.GetManyAsync<ApiResourceClaimsDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceClaims.GetManyAsync<ApiResourceClaimsDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceApiResourceClaims.GetManyAsync<ApiResourceClaimsSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(int id)
        {
            try
            {
                var result = await _serviceApiResourceClaims.GetByIdAsync<ApiResourceClaimsDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] ApiResourceClaimsDTO obj)
        {
            try
            {
                var result = await _serviceApiResourceClaims.CreateAsync<ApiResourceClaimsDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "ApiResourceClaims";
                        nkht.ban_ghi_id = App.Business.Base.CommonInit.IntToGuid(result.id);
                        nkht.duong_dan = "/link-ApiResourceClaims-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] ApiResourceClaimsDTO obj, int id)
        {
            try
            {
                var result = await _serviceApiResourceClaims.UpdateAsync<ApiResourceClaimsDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                var result = await _serviceApiResourceClaims.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<int> ids)
        {
            ...
            try
            {
                var result = await _serviceApiResourceClaims.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
