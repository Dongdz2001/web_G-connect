...
namespace App.Api.Controllers.DBAll
{
    ...
    /// GC_DM_LINH_VUC
    /// </summary>
    [Route("api/link-GC_DM_LINH_VUC")]
    [AuthorizeApi]
    [ApiController]
    public class GC_DM_LINH_VUCController : ControllerBase
    {
        private readonly GC_DM_LINH_VUCIService _serviceGC_DM_LINH_VUC;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public GC_DM_LINH_VUCController(GC_DM_LINH_VUCIService serviceGC_DM_LINH_VUC,
            INhatKyHeThongService nhatkyhethongservice)
        {
            _serviceGC_DM_LINH_VUC = serviceGC_DM_LINH_VUC;
        ...
        public async Task<ActionResult> Get(int page = 1, int page_size = 0, string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.GetManyAsync<GC_DM_LINH_VUCDTO>(page, page_size, sort, filter, search);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetAll(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.GetManyAsync<GC_DM_LINH_VUCDTO>(1, 1000000, sort, filter, search);
        ...
        public async Task<ActionResult> GetSelect(string sort = null, string filter = null, string search = null)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.GetManyAsync<GC_DM_LINH_VUCSelectDTO>(1, 1000000, sort, filter, search);
                return Ok(result.data);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> GetById(Guid id)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.GetByIdAsync<GC_DM_LINH_VUCDTO>(id);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("create")]
        public async Task<ActionResult> Create([FromBody] GC_DM_LINH_VUCDTO obj)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.CreateAsync<GC_DM_LINH_VUCDTO>(obj);
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.bang = "GC_DM_LINH_VUC";
                        nkht.ban_ghi_id = (result.id);
                        nkht.duong_dan = "/link-GC_DM_LINH_VUC-view/" + result.id.ToString();
                        nkht.hanh_dong = "208";
        ...
        public async Task<ActionResult> Update([FromBody] GC_DM_LINH_VUCDTO obj, Guid id)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.UpdateAsync<GC_DM_LINH_VUCDTO>(obj, id);
        ...
        public async Task<ActionResult> Delete(Guid id)
        {
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.DeleteAsync(id);
        ...
        public async Task<ActionResult> Deletes([FromBody] List<Guid> ids)
        {
            ...
            try
            {
                var result = await _serviceGC_DM_LINH_VUC.DeletesAsync(ids);
                return Ok(result);
            }
            catch (Exception ex)
            {
