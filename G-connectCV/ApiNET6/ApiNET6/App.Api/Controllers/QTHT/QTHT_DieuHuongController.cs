...
namespace App.Api.Controllers.QTHT
{
    ...
    [AuthorizeApi]
    [ApiController]
    public class QTHT_DieuHuongController : ControllerBase
    {
        private readonly IDieuHuongService _service;
        private readonly INhatKyHeThongService _nhatkyhethongservice;
        public QTHT_DieuHuongController(IDieuHuongService service,
            ...
            try
            {
                ...
                try
                {
                    if (result != null)
                    {
                        ...
                        nkht.duong_dan = "/dieuhuong-view/" + result.id.ToString();
                        nkht.hanh_dong = "218";
            ...
            try
            {
                ...
                try
                {
                    if (result == true)
                    {
                        ...
                        nkht.bang = "qtht_dieu_huong";
                        nkht.ban_ghi_id = id;
                        nkht.duong_dan = "/dieuhuong-view/" + id.ToString();
                        nkht.hanh_dong = "220";
        ...
        #region PhanLoaiDieuHuong
        /// <summary>
        /// Lấy tree điều hướng
        /// </summary>
        /// <returns></returns>
        [HttpGet("phan-loai-dieu-huong")]
        public async Task<ActionResult> PhanLoaiDieuHuong()
        {
            try
            {
                var result = _service.PhanLoaiDieuHuong();
                return Ok(result);
            }
            catch (Exception ex)
            {
