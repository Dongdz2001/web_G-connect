...
const GC_CONG_VIEC_CHECKLISTFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of GC_CONG_VIEC_CHECKLIST'}>
                <div className="view-form">
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-2">
                                <label htmlFor="ten_id_loai_checklist">
                                    {'Loại checklist'}
                                </label>
                            </div>
                            <div className="col-sm-10">
                                <Controller name="ten_id_loai_checklist" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="ket_qua_mong_muon" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="ghi_chu_khac" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
...
export default GC_CONG_VIEC_CHECKLISTFormView;
