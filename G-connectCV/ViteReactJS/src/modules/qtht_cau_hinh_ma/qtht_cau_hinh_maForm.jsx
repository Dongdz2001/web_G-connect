...
const qtht_cau_hinh_maForm = (props) => {
    const { t, i18n } = useTranslation();
    let { id } = useParams();
    let itemId = props.id ?? id;
    const linkList = '/admin/qtht_cau_hinh_ma';
    const labelSave = 'Lưu';
    const labelClose = 'Đóng';
    const itemService = qtht_cau_hinh_maService;
    ...
    return (
        <div >
            ...
            <Card title={(itemId === 'new' ? 'Thêm' : 'Sửa') + ' Title of qtht_cau_hinh_ma'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                ...
                                <Controller name="gia_tri" control={control} rules={{ 
                                    //validate: value => value === 'pwd' || "The passwords do not match",
                                    //pattern: {
                                    //  value: /^[a-zA-Z]+$/,
                                    //  message: 'pattern'
                                ...
                                {getFormErrorMessage('gia_tri', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
...
export default qtht_cau_hinh_maForm;
