...
const qtht_cau_hinh_maFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of qtht_cau_hinh_ma'}>
                <div className="view-form">
                    <div className='row'>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="gia_tri" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
...
export default qtht_cau_hinh_maFormView;
