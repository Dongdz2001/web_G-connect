...
const OrderList = () => {
    ...
    return (
        <Card title="Danh sách đơn hàng">
            ...
            size="small" value={items} lazy responsiveLayout="stack" dataKey="NM_USR_ID"
            ...
            >
                ...
                <Column body={(row)=>{
                    return (<strong className='text-success'>{row.NM_USR_ID}</strong>)
                }} sortable header="Tổng tiền (đ)" />
                <Column field="VC_FRST_NM" sortable header="Mã đơn hàng" />
                <Column field="VC_FRST_NM" sortable header="Họ tên" />
                <Column field="VC_FRST_NM" sortable header="SĐT" />
                
                <Column style={{ width: '150px' }} body={columnCreatedDate} sortable header="Ngày tạo đơn" />
                <Column style={{ width: '150px' }} field="created_at_utc" body={columnCreatedDate} sortable header="Ngày tạo" />
                <Column style={{ width: '10%' }} field="VC_FRST_NM" body={(rowData)=>{
                    let severity = ''
                    if(rowData.VC_FRST_NM==ACTIVE )severity='success';
                    if(rowData.VC_FRST_NM==DEACTIVE )severity='warning';
                    return(<Tag severity={severity} value={rowData.VC_FRST_NM} />)
