...
const ClientCorsOriginsFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of ClientCorsOrigins'}>
                <div className="view-form">
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-2">
                                <label htmlFor="ten_ClientId">
                                    {'Title of ClientId'}
                                </label>
                            </div>
                            <div className="col-sm-10">
                                <Controller name="ten_ClientId" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
...
export default ClientCorsOriginsFormView;
