...
const GC_DM_LOAI_CHECK_LISTForm = (props) => {
    const { t, i18n } = useTranslation();
    let { id } = useParams();
    let itemId = props.id ?? id;
    const linkList = '/admin/GC_DM_LOAI_CHECK_LIST';
    const labelSave = 'Lưu';
    const labelClose = 'Đóng';
    const itemService = GC_DM_LOAI_CHECK_LISTService;
    ...
    return (
        <div >
            ...
            <Card title={(itemId === 'new' ? 'Thêm' : 'Sửa') + ' Danh mục Loại checklist'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            <div className="col-sm-12">
                                <label htmlFor="ten_loai_check_list">
                                    {'Tên loại checklist'} <span className='p-error'>(*)</span>
                                </label>
                                <Controller name="ten_loai_check_list" control={control} rules={{ 
                                    required: {
                                        value: true,
                                ...
                                {getFormErrorMessage('ten_loai_check_list', errors)}
                            </div>
                        </div>
                        <div className="col-12">
                            <div className="col-sm-12">
...
export default GC_DM_LOAI_CHECK_LISTForm;
