...
const GC_DM_TRANG_THAIFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Danh mục Trạng thái'}>
                    ...
                    <div className='row'>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="ten_trang_thai" control={control} render={({ field, fieldState }) => (
...
export default GC_DM_TRANG_THAIFormView;
