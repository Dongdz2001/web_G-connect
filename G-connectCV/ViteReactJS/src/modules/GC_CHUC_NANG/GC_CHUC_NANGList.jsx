...
dayjs.extend(utc);
const GC_CHUC_NANGList = (props) => {
  const { t, i18n } = useTranslation();
  const openDialog = !false;
  const fieldID = "id";
  const fieldSort = "id";
  const fieldSortOrder = "ASC";
  const linkEdit = "/admin/GC_CHUC_NANG-form";
    ...
    <Card title={titlePage}>
            ...
            <div className="field">
              <span className="p-float-label p-input-icon-right">
                ...
                <InputText
                  ...
                  value={aDVSParams.ma_chuc_nang ?? ""}
                />
                <label htmlFor="ma_chuc_nang">Mã chức năng</label>
              </span>
            </div>
          </div>
          <div className="col-12 col-sm-2">
            <div className="field">
              <span className="p-float-label p-input-icon-right">
                ...
                <InputText
                  ...
                  value={aDVSParams.ten_chuc_nang ?? ""}
                />
                <label htmlFor="ten_chuc_nang">Tên chức năng</label>
              </span>
            </div>
          </div>
            ...
            <div className="field">
              <span className="p-float-label p-input-icon-right">
                ...
                <InputText
                  ...
                  value={aDVSParams.file_dinh_kem ?? ""}
                />
      ...
      >
        ...
        <Column
          ...
          sortable
          header={"Đã công bố"}
          body={(rowData, column) => decodeUnicode(rowData.is_cong_bo)}
        />
        <Column
          field="is_da_code"
          sortable
...
export default GC_CHUC_NANGList;
