...
const UserList = () => {
    ...
    const fieldSort = 'VC_FRST_NM';
    const fieldSortOrder = 'ASC';
    const linkEdit = '/admin/user-form';
    ...
    const titlePage = t('rbkey_ct_ov111rvw', 'Danh sách người dùng');
    const labelAdd = t('rbkey_ct_ov111rvw', 'Thêm người dùng');
    const labelDelete = t('rbkey_ct_ov111rvw', 'Xóa người dùng');
    ...
    const loadLazyData = () => {
        ...
        return userService.filterPage(advanceSearch).then(res => {
        ...
        <Card title={titlePage}>
            ...
            >
               <Column className='text-center' style={{ width: '40px' }} body={(rowData, item)=>{
                ...
                <Column field="DT_CRTN_DT" body={(rowData, column) => columnBodyDate(rowData.created_at_utc)} header={t('rbkey_ct_ov111rvw', 'Ngày tạo')} />
                <Column field="DT_CRTN_DT" body={(rowData, column) => columnBodyState(rowData, column)} header={t('rbkey_ct_ov111rvw', 'Trạng thái')} className={'tdCenter'} />
