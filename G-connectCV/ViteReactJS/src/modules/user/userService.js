...
let path = appSetting.PATH_APILMS_V2 + '/qtht-nguoi-dung'
...
const userService = {
    ...
    checkpassword(password){
        return axios.get(path+'/checkmatkhau?mat_khau=' + password);
    },
    changepassword(password){
        return axios.get(path+'/doimatkhau?mat_khau=' + password);
    },
