...
const qtht_nhat_ky_he_thong_loaiFormView = (props) => {
...
//{K}
    ...
    return (
        <div >
            ...
            <Card title={'Xem Title of qtht_nhat_ky_he_thong_loai'}>
                <div className="view-form">
                    <div className='row'>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col-sm-10">
                                <Controller name="ten_hanh_dong" control={control} render={({ field, fieldState }) => (
                                    <label className="p-inputtext">{field.value??''}</label>
                                )} />
                            </div>
                        </div>
...
export default qtht_nhat_ky_he_thong_loaiFormView;
